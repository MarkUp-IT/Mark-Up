...
export default function MentorCard({ name, description, imgUrl }) {
  ...
  return (
    ...
    >
      ...
      <div className="group w-[293px] h-[253px] bg-[#100A19] flex flex-col items-center gap-3 rounded-[12px] border border-[#EDEDF3]/10 relative overflow-hidden cursor-pointer transition-all duration-300 ease-out hover:border-[#EDEDF3]/20 hover:shadow-[inset_0_0_40px_rgba(14,17,43,0.9),inset_0_1px_0_rgba(255,255,255,0.05)]">
        ...
        {/* Content */}
        <div className="relative z-10 flex flex-col items-center gap-3 w-full h-full">
