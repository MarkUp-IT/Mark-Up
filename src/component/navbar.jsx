...
export default function Navbar() {
  ...
  return (
    <div className="absolute z-50 flex w-full justify-center mt-4">
      <nav className="text-white flex font-jakarta border justify-between bg-white/10 items-center border-white/30 fixed shadow-lg w-[90%] rounded-full z-50">
        <GlassSurfaceDynamic
          width="100%"
          height="100%"
          borderRadius={100}
          className="flex items-center fixed py-3 px-8 justify-between w-full border border-white/10 shadow-lg"
          distortionScale={300}
        >
          <Link href="/">
            <Image
