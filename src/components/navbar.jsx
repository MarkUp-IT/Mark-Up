...
export default function Navbar() {
  ...
  return (
    <nav className="bg-gradient-to-t text-white from-white/35 via-white/30 to-white/25 font-jakarta backdrop-blur-sm border flex justify-between items-center border-white/30 fixed shadow-lg w-[95%] rounded-full py-3 px-8 z-50">
      <Link href="/">
        <Image
