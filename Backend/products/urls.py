...
urlpatterns = [
    ...
    path("<uuid:product_id>/check-invite-email/", check_referral_invitee, name="api_bootcamp_check_invite_email"),
    ...
    path("registration-questions/<uuid:question_id>/", bootcamp_question_detail, name="api_bootcamp_question_detail"),
