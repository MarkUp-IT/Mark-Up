      ...
      <div className="flex-1 flex items-center ml-[288px] py-5 flex-col gap-5 px-10 bg-white">
        ...
        <div className="w-[1158px] h-[72px] bg-[#E2E8F0] flex flex-row items-center justify-center gap-15 rounded-[8px]">
          <div className="flex gap-20 items-center">
            ...
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search session or mentor..."
        ...
        <div className="flex flex-col w-[1158px] mt-2 gap-1">
          ...
          <p className="text-[#64748B] text-[15px]">
            Sistem pemantauan distribusi link Zoom dan status pemenuhan sesi mentoring 1-on-1
          </p>
        </div>
        ...
        <div className="w-[1158px] flex justify-between items-end mt-4">
          <div className="bg-[#F8FAFC] p-4 rounded-[8px] flex flex-row gap-6 border border-[#E2E8F0] shadow-sm">
            ...
            <div className="flex flex-col gap-2">
              <p className="text-[11px] font-bold text-[#64748B]">FILTER BY DATE</p>
              <input
                type="date"
            ...
            {/* Mentor / Speaker */}
            <div className="flex flex-col gap-2">
              <p className="text-[11px] font-bold text-[#64748B]">MENTOR / SPEAKER</p>
              <div className="relative">
            ...
            {/* Session Status */}
            <div className="flex flex-col gap-2">
              <p className="text-[11px] font-bold text-[#64748B]">SESSION STATUS</p>
              <div className="flex bg-white border border-[#CBD5E1] rounded-[6px] p-1 h-[36px]">
                <button
                  ...
                  className={`px-4 text-[12px] font-medium rounded-[4px] transition-colors ${
                    sessionStatus === "All" ? "bg-[#2563EB] text-white" : "text-[#64748B] hover:bg-[#F1F5F9]"
                  }`}
                >
                  All
                </button>
                <button
                  ...
                  className={`px-4 text-[12px] font-medium rounded-[4px] transition-colors ${
                    sessionStatus === "Distributed" ? "bg-[#2563EB] text-white" : "text-[#64748B] hover:bg-[#F1F5F9]"
                  }`}
                >
                  Distributed
                </button>
                <button
                  ...
                  className={`px-4 text-[12px] font-medium rounded-[4px] transition-colors ${
                    sessionStatus === "Pending" ? "bg-[#2563EB] text-white" : "text-[#64748B] hover:bg-[#F1F5F9]"
                  }`}
                >
                  Pending
                </button>
                  ...
                  >
                    ...
                    <td className="px-6 text-center">
                      <div className="flex flex-col items-center justify-center">
                        <p className="text-[#1E293B] font-bold text-[13px]">{item.date}</p>
                      ...
                      <div className="flex flex-row items-center justify-center gap-2">
                        <input 
                          ...
                          className={`w-[180px] h-[36px] rounded-[6px] px-3 text-[12px] outline-none border border-[#E2E8F0] ${
                            item.status === "Distributed" ? "bg-[#F1F5F9] text-[#64748B]" : "bg-white text-[#1E293B] focus:border-[#2563EB]"
                          }`}
                        />
                        <button className={`w-[36px] h-[36px] rounded-[6px] flex items-center justify-center transition-colors ${
                          item.status === "Pending" ? "bg-[#2563EB] text-white hover:bg-[#1D4ED8]" : "bg-[#E2E8F0] text-[#94A3B8] cursor-not-allowed"
                        }`}>
                          <Send size={16} className={item.status === "Pending" ? "" : "opacity-50"} />
                        </button>
                      </div>
                    </td>
                    <td className="px-6 text-center">
