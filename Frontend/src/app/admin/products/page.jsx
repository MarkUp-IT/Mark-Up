...
export default function Produk() {
  ...
  return (
    <div className="w-full font-inter text-black bg-[#F8FAFC] min-h-screen relative flex flex-row">
      ...
      <div className="ml-[288px] flex-1 flex flex-col">
        ...
        <div className="flex-1 flex items-center py-5 flex-col gap-5 px-10 bg-white">
          <div className="flex flex-row items-center justify-between w-[1158px] mt-2">
            <div>
              <p className="font-bold text-[25px]">Products Catalog</p>
          ...
          {/* Grid Stats & Chart - Sudah Diperbaiki Tingginya */}
          <div className="w-[1158px] grid grid-cols-3 gap-5 mt-4">
            ...
            {/* Chart Section */}
            <div className="col-span-2 row-span-2 bg-white border border-[#E2E8F0] shadow-sm rounded-[9px] p-6 flex flex-col h-full">
            ...
            <div className="bg-[#F0FDF4] h-[140px] rounded-[9px] flex flex-col justify-center px-7 shadow-sm border border-[#DCFCE7]">
            ...
            <div className="bg-white h-[140px] rounded-[9px] flex flex-col justify-center px-7 shadow-sm border border-[#E2E8F0]">
          ...
          <div className="w-[1158px] flex flex-col mt-6">
            ...
            {/* Search Bar dan Filter Sejajar Satu Baris */}
              ...
              <div className="flex flex-row items-center gap-4 flex-1">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="bg-white w-[250px] h-[43.5px] rounded-[6px] pl-9 border border-[#E2E8F0] outline-none focus:ring-2 focus:ring-[#2563EB]/20 shadow-sm text-[13px]"
                  />
                </div>
      ...
      {/* MODAL EDIT PRODUK - Kode Lengkap */}
      {isEditOpen && (
        <div
          className="fixed inset-0 bg-black/40 z-40 backdrop-blur-sm transition-opacity"
      ...
      >
        <div className="w-full h-[120px] shrink-0 bg-[#F8FAFC] border-b border-[#E2E8F0] flex flex-col justify-center px-10 gap-1">
          ...
          <p className="text-[#64748B] text-[14px]">
            ...
            {selectedProduct?.title || "the selected product"}.
          </p>
        </div>
        ...
        <div className="px-10 py-8 flex flex-col gap-6">
          <div className="flex flex-col gap-2">
            ...
            <div className="bg-[#F8FAFC] w-full h-[180px] rounded-[8px] flex flex-col items-center justify-center border-2 border-dashed border-[#CBD5E1] hover:bg-[#F1F5F9] hover:border-[#94A3B8] transition-all cursor-pointer">
              ...
              <p className="text-[#1E293B] font-semibold text-[15px] mb-1">
                Click to upload new or drag and drop
              </p>
              <p className="text-[#64748B] text-[13px]">
                Recommended: 1280x590px (Max 5MB)
              </p>
          ...
          <div className="flex gap-4 w-full">
            <div className="flex flex-col gap-2 flex-1">
              ...
              <input
                type="number"
                defaultValue={selectedProduct?.price?.replace(/[^0-9]/g, "")}
                placeholder="0"
                className="w-full h-[48px] bg-[#F8FAFC] border border-[#E2E8F0] rounded-[6px] px-4 outline-none focus:border-[#2563EB] focus:ring-1 focus:ring-[#2563EB] transition-all text-[#1E293B] placeholder:text-[#94A3B8]"
              />
            </div>
