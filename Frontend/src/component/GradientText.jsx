...
export default function GradientText({
  ...
  return (
    <motion.div
      className={`relative mx-auto flex max-w-fit flex-row items-center justify-center rounded-[1.25rem] transition-shadow duration-500 overflow-hidden ${showBorder ? 'py-1 px-2' : ''} ${className}`}
